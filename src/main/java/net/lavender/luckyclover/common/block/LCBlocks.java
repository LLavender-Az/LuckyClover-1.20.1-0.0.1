...
import net.lavender.luckyclover.common.block.common.CloverBlock;
import net.lavender.luckyclover.common.block.common.SackBlock;
import net.lavender.luckyclover.common.block.common.PottedCloverBlock;
...
public class LCBlocks {
    ...
    public static final RegistryObject<Block> CLOVER_SACK = registerBlock("clover_sack",
            () -> new SackBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).instrument(NoteBlockInstrument.GUITAR)
    ...
    public static final RegistryObject<Block> POTTED_CLOVER = BLOCKS.register("potted_clover",
            () -> new PottedCloverBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), LCBlocks.CLOVER_PLANT, BlockBehaviour.Properties.of()
