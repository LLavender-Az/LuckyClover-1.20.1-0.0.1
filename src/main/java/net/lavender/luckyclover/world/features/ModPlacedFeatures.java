...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> CLOVER_PLACED_UNDERGROUND_KEY = registerKey("clover_underground_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, CLOVER_PLACED_UNDERGROUND_KEY, configuredFeature.getOrThrow(ModConfiguredFeatures.CLOVER_UNDERGROUND_KEY),
