...
import net.lavender.luckyclover.datagen.data.AddFeaturesByFilterBiomeModifier;
...
public class ModBiomeModifiers
{
	public static DeferredRegister<Codec<? extends BiomeModifier>> BIOME_MODIFIER_SERIALIZERS =
			DeferredRegister.create(ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, LuckyClover.MOD_ID);
